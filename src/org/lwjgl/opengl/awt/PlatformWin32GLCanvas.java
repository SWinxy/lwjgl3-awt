...
public class PlatformWin32GLCanvas implements PlatformGLCanvas {
        ...
        try (AWT awt = new AWT(canvas)) {
            try (MemoryStack stack = MemoryStack.stackPush()) {
                ...
                WindowProc defaultWndProc = new WindowProc() {
                    public long invoke(long hwnd1, int uMsg, long wParam, long lParam) {
                        return User32.DefWindowProc(hwnd1, uMsg, wParam, lParam);
                    }
                };
                ...
                long result = User32.CreateWindowEx(User32.WS_EX_APPWINDOW, "AWTAPPWNDCLASS",
                        "", 0, User32.CW_USEDEFAULT, User32.CW_USEDEFAULT, 800, 600,
                        NULL, NULL, HINSTANCE, defaultWndProc.address());

                long create = create(hwnd, result, attribs, effective);

                User32.DestroyWindow(result);
                defaultWndProc.free();
    ...
    private long create(long windowHandle, long dummyWindowHandle, GLData attribs, GLData effective) throws AWTException {
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            PIXELFORMATDESCRIPTOR pfd = PIXELFORMATDESCRIPTOR
                    ...
                    .dwLayerMask(GDI32.PFD_MAIN_PLANE)
            ...
            if (wglGetExtensionsStringARBAddr != 0L) {
                ...
                wglExtensions = str == 0L ? "" : MemoryUtil.memASCII(str);
            } else {
    ...
    public boolean isCurrent(long context) {
        return context == WGL.wglGetCurrentContext();
    }
